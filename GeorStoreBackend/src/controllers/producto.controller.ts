...
import { pool } from '../db';
import { tbCategoria, tbColor, tbEmpresa, tbMarca, tbProducto, tbTalla } from "../core/tables";
...
const insert = async (req: Request, res: Response) => {
    try {
        const { id_empresa } = req.body.user;
        const { codigo, nombre, descrip, precio, id_categoria, id_talla, id_color, id_marca } = req.body;
