...
export class MarcaService {
  ...
  url = `${environment.baseUrl}/api/marca`

  #state = signal<State<Marca[]>>({ isLoading: false, data: [] })
  listMarca = computed(() => this.#state().data)
  ...
  setEstado(id: number, estado: string) {
    return this.http.patch(this.url, { estado, id_marca: id })
  }
}
